...
public class CertificationServiceImpl implements CertificationService {
    ...
    public CertificationServiceImpl(CertificationMapper a, ResumeMapper b) { this.certificationMapper = a; this.resumeMapper = b; }
    @Override @Transactional
    public Boolean addCertification(Certification certification, Integer currentUserId) {
        if (certification == null || certification.getResumeId() == null || !StringUtils.hasText(certification.getName())) return false;
        ...
        if (certification.getIssueDate() != null && certification.getExpiryDate() != null && certification.getExpiryDate().isBefore(certification.getIssueDate())) return false;
    ...
    public Boolean updateCertification(Certification certification, Integer currentUserId) {
        ...
        if (certification.getIssueDate() != null && certification.getExpiryDate() != null && certification.getExpiryDate().isBefore(certification.getIssueDate())) return false;
        if (certification.getName() == null && certification.getIssuingOrganization() == null && certification.getIssueDate() == null && certification.getExpiryDate() == null && certification.getCredentialId() == null && certification.getCredentialUrl() == null && certification.getSortOrder() == null) return false;
